...
class MyTestCase(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.GNT_employee_Series = pd.read_excel("data_fail/GTN_wrong_employee.xlsx", usecols=["employee_id"], squeeze=True)
    ...
    def test_employees_in_GTN_can_be_mapped_to_payrun(self):
        ...
        self.assertTrue(series_match, "The Employees in GNT does NOT Match Employees in payrun")
